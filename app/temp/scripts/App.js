...
var StickyHeader = function () {
	function StickyHeader() {
		...
		this.pageSections = (0, _jquery2.default)(".page-section"); /*collection of all elements with the class of page-section*/
...
var Modal = function () {
	function Modal() {
		...
		this.openModalButton = (0, _jquery2.default)(".open-modal"); /*trigger OPEN modal buttons*/
		this.modal = (0, _jquery2.default)(".modal"); /*modal section which will be opened/closed*/
		this.closeModalButton = (0, _jquery2.default)(".modal__close"); /*trigger CLOSE modal buttons*/
